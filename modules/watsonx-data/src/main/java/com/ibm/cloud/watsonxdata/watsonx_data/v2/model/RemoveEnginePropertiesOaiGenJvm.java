 ...
 * JVM properties.
 */
public class RemoveEnginePropertiesOaiGenJvm extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing RemoveEnginePropertiesOaiGenJvm instance.
     *
     * @param removeEnginePropertiesOaiGenJvm the instance to initialize the Builder with
     */
    private Builder(RemoveEnginePropertiesOaiGenJvm removeEnginePropertiesOaiGenJvm) {
      this.coordinator = removeEnginePropertiesOaiGenJvm.coordinator;
      this.worker = removeEnginePropertiesOaiGenJvm.worker;
    }
    ...
    /**
     * Builds a RemoveEnginePropertiesOaiGenJvm.
     *
     * @return the new RemoveEnginePropertiesOaiGenJvm instance
     */
    public RemoveEnginePropertiesOaiGenJvm build() {
      return new RemoveEnginePropertiesOaiGenJvm(this);
    }
     ...
     * @return the RemoveEnginePropertiesOaiGenJvm builder
     */
  ...
  protected RemoveEnginePropertiesOaiGenJvm() { }

  protected RemoveEnginePropertiesOaiGenJvm(Builder builder) {
   ...
   * New builder.
   *
   * @return a RemoveEnginePropertiesOaiGenJvm builder
   */
