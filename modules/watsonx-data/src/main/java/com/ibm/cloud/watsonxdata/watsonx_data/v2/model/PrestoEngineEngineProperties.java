...
public class PrestoEngineEngineProperties extends GenericModel {
  ...
  protected PrestoEnginePropertiesJMX jmxExporterConfig;
  ...
  public static class Builder {
    ...
    private PrestoEnginePropertiesJMX jmxExporterConfig;
    ...
    private Builder(PrestoEngineEngineProperties prestoEngineEngineProperties) {
      ...
      this.jmxExporterConfig = prestoEngineEngineProperties.jmxExporterConfig;
     ...
     * @return the PrestoEngineEngineProperties builder
     */
    public Builder jmxExporterConfig(PrestoEnginePropertiesJMX jmxExporterConfig) {
   ...
   */
  public PrestoEnginePropertiesJMX jmxExporterConfig() {
