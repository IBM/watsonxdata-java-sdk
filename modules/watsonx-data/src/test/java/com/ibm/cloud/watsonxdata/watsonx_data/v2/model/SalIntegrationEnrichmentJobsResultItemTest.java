...
/**
 * Unit test class for the SalIntegrationEnrichmentJobsResultItem model.
 */
public class SalIntegrationEnrichmentJobsResultItemTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testSalIntegrationEnrichmentJobsResultItem() throws Throwable {
    SalIntegrationEnrichmentJobsResultItem salIntegrationEnrichmentJobsResultItemModel = new SalIntegrationEnrichmentJobsResultItem();
    assertNull(salIntegrationEnrichmentJobsResultItemModel.getEntity());
    assertNull(salIntegrationEnrichmentJobsResultItemModel.getMetadata());
  }
}