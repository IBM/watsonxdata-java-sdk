...
/**
 * Unit test class for the TestLHConsoleOptions model.
 */
public class TestLHConsoleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testTestLHConsoleOptions() throws Throwable {
    TestLHConsoleOptions testLhConsoleOptionsModel = new TestLHConsoleOptions();
    assertNotNull(testLhConsoleOptionsModel);
  }
}