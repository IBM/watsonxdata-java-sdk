...
/**
 * Unit test class for the UpdateMdsOptions model.
 */
public class UpdateMdsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateMdsOptions() throws Throwable {
    ...
    UpdateMdsOptions updateMdsOptionsModel = new UpdateMdsOptions.Builder()
      ...
      .build();
    assertEquals(updateMdsOptionsModel.body(), java.util.Arrays.asList(jsonPatchOperationModel));
    assertEquals(updateMdsOptionsModel.lhInstanceId(), "testString");
    assertEquals(updateMdsOptionsModel.authInstanceId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateMdsOptionsError() throws Throwable {
    new UpdateMdsOptions.Builder().build();
  }
