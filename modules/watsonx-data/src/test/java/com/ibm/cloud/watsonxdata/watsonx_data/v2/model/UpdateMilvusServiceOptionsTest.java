...
/**
 * Unit test class for the UpdateMilvusServiceOptions model.
 */
public class UpdateMilvusServiceOptionsTest {
  ...
  public void testUpdateMilvusServiceOptionsError() throws Throwable {
    new UpdateMilvusServiceOptions.Builder().build();
  }
