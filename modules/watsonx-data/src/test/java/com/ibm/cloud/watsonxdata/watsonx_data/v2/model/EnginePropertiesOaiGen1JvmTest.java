...
public class EnginePropertiesOaiGen1JvmTest {
  ...
  public void testEnginePropertiesOaiGen1Jvm() throws Throwable {
    ...
    assertEquals(enginePropertiesOaiGen1JvmModelNew.coordinator().toString(), nodeDescriptionBodyModel.toString());
    assertEquals(enginePropertiesOaiGen1JvmModelNew.worker().toString(), nodeDescriptionBodyModel.toString());
  }
}