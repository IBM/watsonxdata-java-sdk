...
/**
 * Unit test class for the UpdateBucketRegistrationOptions model.
 */
public class UpdateBucketRegistrationOptionsTest {
  ...
  public void testUpdateBucketRegistrationOptionsError() throws Throwable {
    new UpdateBucketRegistrationOptions.Builder().build();
  }
