...
/**
 * Unit test class for the EnginesServicesDetails model.
 */
public class EnginesServicesDetailsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testEnginesServicesDetails() throws Throwable {
    EnginesServicesDetails enginesServicesDetailsModel = new EnginesServicesDetails();
    assertNull(enginesServicesDetailsModel.getEnginesServices());
  }
}