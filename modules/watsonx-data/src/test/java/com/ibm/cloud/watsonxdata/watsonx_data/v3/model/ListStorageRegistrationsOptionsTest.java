...
/**
 * Unit test class for the ListStorageRegistrationsOptions model.
 */
public class ListStorageRegistrationsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListStorageRegistrationsOptions() throws Throwable {
    ListStorageRegistrationsOptions listStorageRegistrationsOptionsModel = new ListStorageRegistrationsOptions.Builder()
      .authInstanceId("testString")
      .build();
    assertEquals(listStorageRegistrationsOptionsModel.authInstanceId(), "testString");
  }
}