...
/**
 * Unit test class for the SparkEngineCollection model.
 */
public class SparkEngineCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testSparkEngineCollection() throws Throwable {
    SparkEngineCollection sparkEngineCollectionModel = new SparkEngineCollection();
    assertNull(sparkEngineCollectionModel.getSparkEngines());
  }
}