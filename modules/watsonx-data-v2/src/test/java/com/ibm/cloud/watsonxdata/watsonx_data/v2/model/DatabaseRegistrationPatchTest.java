...
public class DatabaseRegistrationPatchTest {
  ...
  public void testDatabaseRegistrationPatch() throws Throwable {
    ...
    assertEquals(databaseRegistrationPatchTablesItemsModel.fileName(), "sample file name");
    ...
    assertEquals(databaseRegistrationPatchModel.databaseProperties(), java.util.Arrays.asList(databaseRegistrationPatchDatabaseDetailsDatabasePropertiesItemsModel));
  ...
  public void testDatabaseRegistrationPatchAsPatch() throws Throwable {
    ...
    assertTrue(mergePatch.containsKey("database_properties"));
