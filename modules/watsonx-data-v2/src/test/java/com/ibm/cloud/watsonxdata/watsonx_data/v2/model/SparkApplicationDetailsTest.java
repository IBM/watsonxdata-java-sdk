...
public class SparkApplicationDetailsTest {
  ...
  public void testSparkApplicationDetails() throws Throwable {
    ...
    assertEquals(sparkApplicationDetailsModel.runtime(), sparkApplicationDetailsRuntimeModel);
    ...
    assertEquals(sparkApplicationDetailsModelNew.runtime().toString(), sparkApplicationDetailsRuntimeModel.toString());
  }
}