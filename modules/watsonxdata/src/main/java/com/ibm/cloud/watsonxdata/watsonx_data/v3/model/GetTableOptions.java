...
public class GetTableOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(GetTableOptions getTableOptions) {
      this.catalogName = getTableOptions.catalogName;
      this.schemaName = getTableOptions.schemaName;
      this.tableName = getTableOptions.tableName;
     ...
     */
    public Builder(String catalogName, String schemaName, String tableName, String engineId) {
