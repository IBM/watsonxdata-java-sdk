...
/**
 * Unit test class for the EnginePropertiesJvm model.
 */
public class EnginePropertiesJvmTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testEnginePropertiesJvm() throws Throwable {
    ...
    String json = TestUtilities.serialize(enginePropertiesJvmModel);

    EnginePropertiesJvm enginePropertiesJvmModelNew = TestUtilities.deserialize(json, EnginePropertiesJvm.class);
    assertTrue(enginePropertiesJvmModelNew instanceof EnginePropertiesJvm);
  }
}