...
/**
 * Unit test class for the Endpoint model.
 */
public class EndpointTest {
  ...
  public void testEndpoint() throws Throwable {
    ...
    assertNull(endpointModel.getExternalHost());
    assertNull(endpointModel.getServiceStatus());
    assertNull(endpointModel.getServiceType());
  }
}