...
/**
 * Unit test class for the CatalogCollection model.
 */
public class CatalogCollectionTest {
  ...
  @Test
  public void testCatalogCollection() throws Throwable {
    CatalogCollection catalogCollectionModel = new CatalogCollection();
    assertNull(catalogCollectionModel.getCatalogs());
  }
}