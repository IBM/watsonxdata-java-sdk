...
/**
 * Unit test class for the WatsonxInstanceDetails model.
 */
public class WatsonxInstanceDetailsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testWatsonxInstanceDetails() throws Throwable {
    WatsonxInstanceDetails watsonxInstanceDetailsModel = new WatsonxInstanceDetails();
    assertNull(watsonxInstanceDetailsModel.getResources());
    assertNull(watsonxInstanceDetailsModel.getWatsonxDataInstance());
  }
}