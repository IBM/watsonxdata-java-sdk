...
/**
 * Unit test class for the StorageRegistrationCollection model.
 */
public class StorageRegistrationCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testStorageRegistrationCollection() throws Throwable {
    StorageRegistrationCollection storageRegistrationCollectionModel = new StorageRegistrationCollection();
    assertNull(storageRegistrationCollectionModel.getStorageRegistrations());
  }
}