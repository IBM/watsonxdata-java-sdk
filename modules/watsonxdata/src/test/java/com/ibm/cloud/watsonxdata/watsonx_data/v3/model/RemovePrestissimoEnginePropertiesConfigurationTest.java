...
/**
 * Unit test class for the RemovePrestissimoEnginePropertiesConfiguration model.
 */
public class RemovePrestissimoEnginePropertiesConfigurationTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRemovePrestissimoEnginePropertiesConfiguration() throws Throwable {
    ...
    String json = TestUtilities.serialize(removePrestissimoEnginePropertiesConfigurationModel);

    RemovePrestissimoEnginePropertiesConfiguration removePrestissimoEnginePropertiesConfigurationModelNew = TestUtilities.deserialize(json, RemovePrestissimoEnginePropertiesConfiguration.class);
    assertTrue(removePrestissimoEnginePropertiesConfigurationModelNew instanceof RemovePrestissimoEnginePropertiesConfiguration);
  }
}