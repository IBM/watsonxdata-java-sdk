...
/**
 * Unit test class for the GetInstanceConfigurationOptions model.
 */
public class GetInstanceConfigurationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetInstanceConfigurationOptions() throws Throwable {
    GetInstanceConfigurationOptions getInstanceConfigurationOptionsModel = new GetInstanceConfigurationOptions.Builder()
      .authInstanceId("testString")
      .build();
    assertEquals(getInstanceConfigurationOptionsModel.authInstanceId(), "testString");
  }
}