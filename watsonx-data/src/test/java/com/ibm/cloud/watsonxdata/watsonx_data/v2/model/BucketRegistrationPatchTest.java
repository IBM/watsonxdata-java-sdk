...
public class BucketRegistrationPatchTest {
  ...
  public void testBucketRegistrationPatch() throws Throwable {
    ...
    assertEquals(bucketRegistrationPatchModel.systemBucketUpdateCredentials(), Boolean.valueOf(true));
    ...
    assertEquals(bucketRegistrationPatchModelNew.systemBucketUpdateCredentials(), Boolean.valueOf(true));
  }
  @Test
  public void testBucketRegistrationPatchAsPatch() throws Throwable {
    ...
    assertTrue(mergePatch.containsKey("system_bucket_update_credentials"));
