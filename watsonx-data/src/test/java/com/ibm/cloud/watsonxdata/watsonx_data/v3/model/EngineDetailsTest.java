...
/**
 * Unit test class for the EngineDetails model.
 */
public class EngineDetailsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testEngineDetails() throws Throwable {
    ...
    String json = TestUtilities.serialize(engineDetailsModel);

    EngineDetails engineDetailsModelNew = TestUtilities.deserialize(json, EngineDetails.class);
    assertTrue(engineDetailsModelNew instanceof EngineDetails);
    assertEquals(engineDetailsModelNew.coordinator().toString(), coordinatorNodeDescriptionBodyModel.toString());
    assertEquals(engineDetailsModelNew.sizeConfig(), "starter");
    assertEquals(engineDetailsModelNew.worker().toString(), workerNodeDescriptionBodyModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testEngineDetailsError() throws Throwable {
    new EngineDetails.Builder().build();
  }
