...
public class DatabaseCatalogTest {
  ...
  public void testDatabaseCatalog() throws Throwable {
    DatabaseCatalog databaseCatalogModel = new DatabaseCatalog();
    assertNull(databaseCatalogModel.getCatalogName());
    assertNull(databaseCatalogModel.getCatalogTags());
    assertNull(databaseCatalogModel.getCatalogType());
  }
}