...
/**
 * Unit test class for the ResourceCollection model.
 */
public class ResourceCollectionTest {
  ...
  @Test
  public void testResourceCollection() throws Throwable {
    ResourceCollection resourceCollectionModel = new ResourceCollection();
    assertNull(resourceCollectionModel.getDetails());
    assertNull(resourceCollectionModel.getType());
  }
}