...
/**
 * Unit test class for the CreateSalIntegrationEnrichmentSettingsOptions model.
 */
public class CreateSalIntegrationEnrichmentSettingsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateSalIntegrationEnrichmentSettingsOptions() throws Throwable {
    ...
    CreateSalIntegrationEnrichmentSettingsOptions createSalIntegrationEnrichmentSettingsOptionsModel = new CreateSalIntegrationEnrichmentSettingsOptions.Builder()
      ...
      .build();
    assertEquals(createSalIntegrationEnrichmentSettingsOptionsModel.semanticExpansion(), salIntegrationEnrichmentSettingsSemanticExpansionModel);
    assertEquals(createSalIntegrationEnrichmentSettingsOptionsModel.termAssignment(), salIntegrationEnrichmentSettingsTermAssignmentModel);
    assertEquals(createSalIntegrationEnrichmentSettingsOptionsModel.projectId(), "testString");
    assertEquals(createSalIntegrationEnrichmentSettingsOptionsModel.authInstanceId(), "testString");
  }
}