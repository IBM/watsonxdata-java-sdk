...
/**
 * Unit test class for the ConnectionPropertiesDetails model.
 */
public class ConnectionPropertiesDetailsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testConnectionPropertiesDetails() throws Throwable {
    ConnectionPropertiesDetails connectionPropertiesDetailsModel = new ConnectionPropertiesDetails();
    assertNull(connectionPropertiesDetailsModel.getConnectionName());
    assertNull(connectionPropertiesDetailsModel.getDetails());
    assertNull(connectionPropertiesDetailsModel.getXProperties());
    assertNull(connectionPropertiesDetailsModel.getType());
  }
}