...
/**
 * Unit test class for the SalIntegrationEnrichmentJobsResultItemEntity model.
 */
public class SalIntegrationEnrichmentJobsResultItemEntityTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testSalIntegrationEnrichmentJobsResultItemEntity() throws Throwable {
    SalIntegrationEnrichmentJobsResultItemEntity salIntegrationEnrichmentJobsResultItemEntityModel = new SalIntegrationEnrichmentJobsResultItemEntity();
    assertNull(salIntegrationEnrichmentJobsResultItemEntityModel.getJob());
  }
}