...
/**
 * Unit test class for the PrestissimoEnginePropertiesConfiguration model.
 */
public class PrestissimoEnginePropertiesConfigurationTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPrestissimoEnginePropertiesConfiguration() throws Throwable {
    ...
    String json = TestUtilities.serialize(prestissimoEnginePropertiesConfigurationModel);

    PrestissimoEnginePropertiesConfiguration prestissimoEnginePropertiesConfigurationModelNew = TestUtilities.deserialize(json, PrestissimoEnginePropertiesConfiguration.class);
    assertTrue(prestissimoEnginePropertiesConfigurationModelNew instanceof PrestissimoEnginePropertiesConfiguration);
  }
}