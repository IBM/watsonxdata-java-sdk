...
/**
 * Unit test class for the CreateSalIntegrationEnrichmentGlobalSettingsOptions model.
 */
public class CreateSalIntegrationEnrichmentGlobalSettingsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateSalIntegrationEnrichmentGlobalSettingsOptions() throws Throwable {
    ...
    CreateSalIntegrationEnrichmentGlobalSettingsOptions createSalIntegrationEnrichmentGlobalSettingsOptionsModel = new CreateSalIntegrationEnrichmentGlobalSettingsOptions.Builder()
      ...
      .build();
    assertEquals(createSalIntegrationEnrichmentGlobalSettingsOptionsModel.semanticExpansion(), salIntegrationEnrichmentSettingsSemanticExpansionModel);
    assertEquals(createSalIntegrationEnrichmentGlobalSettingsOptionsModel.termAssignment(), salIntegrationEnrichmentSettingsTermAssignmentModel);
    assertEquals(createSalIntegrationEnrichmentGlobalSettingsOptionsModel.authInstanceId(), "testString");
  }
}