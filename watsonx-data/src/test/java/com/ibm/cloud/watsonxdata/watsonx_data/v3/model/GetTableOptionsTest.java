...
public class GetTableOptionsTest {
  ...
  public void testGetTableOptions() throws Throwable {
    GetTableOptions getTableOptionsModel = new GetTableOptions.Builder()
      ...
      .build();
    assertEquals(getTableOptionsModel.catalogName(), "testString");
    assertEquals(getTableOptionsModel.schemaName(), "testString");
    assertEquals(getTableOptionsModel.tableName(), "testString");
