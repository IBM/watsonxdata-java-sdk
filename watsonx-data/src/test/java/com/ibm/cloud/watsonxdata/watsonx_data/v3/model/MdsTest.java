...
/**
 * Unit test class for the Mds model.
 */
public class MdsTest {
  ...
  @Test
  public void testMds() throws Throwable {
    Mds mdsModel = new Mds();
    assertNull(mdsModel.isMdsEnabled());
    assertNull(mdsModel.getMdsService());
    assertNull(mdsModel.getStatus());
  }
}