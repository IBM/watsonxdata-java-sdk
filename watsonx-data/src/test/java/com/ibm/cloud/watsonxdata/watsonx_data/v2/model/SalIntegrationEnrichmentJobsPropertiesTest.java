...
/**
 * Unit test class for the SalIntegrationEnrichmentJobsProperties model.
 */
public class SalIntegrationEnrichmentJobsPropertiesTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testSalIntegrationEnrichmentJobsProperties() throws Throwable {
    SalIntegrationEnrichmentJobsProperties salIntegrationEnrichmentJobsPropertiesModel = new SalIntegrationEnrichmentJobsProperties();
    assertNull(salIntegrationEnrichmentJobsPropertiesModel.getResults());
    assertNull(salIntegrationEnrichmentJobsPropertiesModel.getTotalRows());
  }
}