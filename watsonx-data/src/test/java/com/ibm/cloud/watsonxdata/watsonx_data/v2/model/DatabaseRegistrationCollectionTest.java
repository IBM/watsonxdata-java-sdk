...
/**
 * Unit test class for the DatabaseRegistrationCollection model.
 */
public class DatabaseRegistrationCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDatabaseRegistrationCollection() throws Throwable {
    DatabaseRegistrationCollection databaseRegistrationCollectionModel = new DatabaseRegistrationCollection();
    assertNull(databaseRegistrationCollectionModel.getDatabaseRegistrations());
  }
}