...
/**
 * Unit test class for the SalIntegrationEnrichmentJobs model.
 */
public class SalIntegrationEnrichmentJobsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testSalIntegrationEnrichmentJobs() throws Throwable {
    SalIntegrationEnrichmentJobs salIntegrationEnrichmentJobsModel = new SalIntegrationEnrichmentJobs();
    assertNull(salIntegrationEnrichmentJobsModel.getJobs());
  }
}