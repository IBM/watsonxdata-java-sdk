...
public class IntegrationPatchTest {
  ...
  public void testIntegrationPatch() throws Throwable {
    ...
    assertEquals(integrationPatchModel.url(), "http://abcd.efgh.com:9876/");
    ...
    assertEquals(integrationPatchModelNew.url(), "http://abcd.efgh.com:9876/");
  ...
  public void testIntegrationPatchAsPatch() throws Throwable {
    ...
    assertEquals(mergePatch.get("url"), "http://abcd.efgh.com:9876/");
