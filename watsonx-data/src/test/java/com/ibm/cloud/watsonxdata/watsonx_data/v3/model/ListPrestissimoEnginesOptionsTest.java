...
/**
 * Unit test class for the ListPrestissimoEnginesOptions model.
 */
public class ListPrestissimoEnginesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListPrestissimoEnginesOptions() throws Throwable {
    ListPrestissimoEnginesOptions listPrestissimoEnginesOptionsModel = new ListPrestissimoEnginesOptions.Builder()
      .authInstanceId("testString")
      .build();
    assertEquals(listPrestissimoEnginesOptionsModel.authInstanceId(), "testString");
  }
}