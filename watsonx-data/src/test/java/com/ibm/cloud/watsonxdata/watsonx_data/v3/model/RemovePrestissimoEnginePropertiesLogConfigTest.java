...
/**
 * Unit test class for the RemovePrestissimoEnginePropertiesLogConfig model.
 */
public class RemovePrestissimoEnginePropertiesLogConfigTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRemovePrestissimoEnginePropertiesLogConfig() throws Throwable {
    ...
    String json = TestUtilities.serialize(removePrestissimoEnginePropertiesLogConfigModel);

    RemovePrestissimoEnginePropertiesLogConfig removePrestissimoEnginePropertiesLogConfigModelNew = TestUtilities.deserialize(json, RemovePrestissimoEnginePropertiesLogConfig.class);
    assertTrue(removePrestissimoEnginePropertiesLogConfigModelNew instanceof RemovePrestissimoEnginePropertiesLogConfig);
  }
}