...
/**
 * Unit test class for the RemoveEnginePropertiesJvm model.
 */
public class RemoveEnginePropertiesJvmTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRemoveEnginePropertiesJvm() throws Throwable {
    ...
    String json = TestUtilities.serialize(removeEnginePropertiesJvmModel);

    RemoveEnginePropertiesJvm removeEnginePropertiesJvmModelNew = TestUtilities.deserialize(json, RemoveEnginePropertiesJvm.class);
    assertTrue(removeEnginePropertiesJvmModelNew instanceof RemoveEnginePropertiesJvm);
  }
}