...
/**
 * Unit test class for the ListPrestoEnginesOptions model.
 */
public class ListPrestoEnginesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListPrestoEnginesOptions() throws Throwable {
    ListPrestoEnginesOptions listPrestoEnginesOptionsModel = new ListPrestoEnginesOptions.Builder()
      .authInstanceId("testString")
      .build();
    assertEquals(listPrestoEnginesOptionsModel.authInstanceId(), "testString");
  }
}