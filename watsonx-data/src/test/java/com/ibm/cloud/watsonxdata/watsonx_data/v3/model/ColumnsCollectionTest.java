...
/**
 * Unit test class for the ColumnsCollection model.
 */
public class ColumnsCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testColumnsCollection() throws Throwable {
    ColumnsCollection columnsCollectionModel = new ColumnsCollection();
    assertNull(columnsCollectionModel.getColumns());
    assertNull(columnsCollectionModel.getCount());
  }
}