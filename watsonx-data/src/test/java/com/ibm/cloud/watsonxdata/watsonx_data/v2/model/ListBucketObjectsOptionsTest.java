...
/**
 * Unit test class for the ListBucketObjectsOptions model.
 */
public class ListBucketObjectsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListBucketObjectsOptions() throws Throwable {
  ...
  public void testListBucketObjectsOptionsError() throws Throwable {
    new ListBucketObjectsOptions.Builder().build();
  }
