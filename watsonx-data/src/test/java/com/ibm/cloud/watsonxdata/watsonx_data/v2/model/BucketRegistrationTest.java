...
public class BucketRegistrationTest {
  ...
  public void testBucketRegistration() throws Throwable {
    ...
    assertNull(bucketRegistrationModel.getAssociatedCatalog());
    assertNull(bucketRegistrationModel.getBucketDetails());
    ...
    assertNull(bucketRegistrationModel.isSystemBucketUpdateCredentials());
