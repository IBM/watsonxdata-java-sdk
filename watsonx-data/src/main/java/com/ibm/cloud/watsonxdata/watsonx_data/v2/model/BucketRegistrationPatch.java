...
public class BucketRegistrationPatch extends GenericModel {
  ...
  @SerializedName("system_bucket_update_credentials")
  protected Boolean systemBucketUpdateCredentials;
  ...
  public static class Builder {
    ...
    private Boolean systemBucketUpdateCredentials;
    ...
    private Builder(BucketRegistrationPatch bucketRegistrationPatch) {
      ...
      this.systemBucketUpdateCredentials = bucketRegistrationPatch.systemBucketUpdateCredentials;
    ...
    /**
     * Set the systemBucketUpdateCredentials.
     *
     * @param systemBucketUpdateCredentials the systemBucketUpdateCredentials
     * @return the BucketRegistrationPatch builder
     */
    public Builder systemBucketUpdateCredentials(Boolean systemBucketUpdateCredentials) {
      this.systemBucketUpdateCredentials = systemBucketUpdateCredentials;
      return this;
    }
  ...
  protected BucketRegistrationPatch(Builder builder) {
    ...
    systemBucketUpdateCredentials = builder.systemBucketUpdateCredentials;
    tags = builder.tags;
  }
  ...
  /**
   * Gets the systemBucketUpdateCredentials.
   *
   * Boolean value to specify whether the patch is for updating HMAC credentials for internal system bucket.
   *
   * @return the systemBucketUpdateCredentials
   */
  public Boolean systemBucketUpdateCredentials() {
    return systemBucketUpdateCredentials;
  }
