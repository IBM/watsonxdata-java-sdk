...
public class GetBucketObjectPropertiesOptions extends GenericModel {
  ...
  protected List<BucketObjectSizePathsItems> paths;
  ...
  public static class Builder {
    ...
    private List<BucketObjectSizePathsItems> paths;
     ...
     */
    public Builder addPaths(BucketObjectSizePathsItems paths) {
      com.ibm.cloud.sdk.core.util.Validator.notNull(paths,
        "paths cannot be null");
      if (this.paths == null) {
        this.paths = new ArrayList<BucketObjectSizePathsItems>();
      }
     ...
     * @return the GetBucketObjectPropertiesOptions builder
     */
    public Builder paths(List<BucketObjectSizePathsItems> paths) {
      this.paths = paths;
      return this;
    }
   ...
   * @return the paths
   */
  public List<BucketObjectSizePathsItems> paths() {
    return paths;
  }
