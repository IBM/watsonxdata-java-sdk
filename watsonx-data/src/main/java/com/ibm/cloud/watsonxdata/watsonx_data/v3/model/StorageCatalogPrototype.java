 ...
 * storage catalog.
 */
public class StorageCatalogPrototype extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing StorageCatalogPrototype instance.
     *
     * @param storageCatalogPrototype the instance to initialize the Builder with
     */
    private Builder(StorageCatalogPrototype storageCatalogPrototype) {
      this.basePath = storageCatalogPrototype.basePath;
      this.catalogName = storageCatalogPrototype.catalogName;
      this.catalogTags = storageCatalogPrototype.catalogTags;
      this.catalogType = storageCatalogPrototype.catalogType;
    }
    ...
    /**
     * Builds a StorageCatalogPrototype.
     *
     * @return the new StorageCatalogPrototype instance
     */
    public StorageCatalogPrototype build() {
      return new StorageCatalogPrototype(this);
    }
     ...
     * @return the StorageCatalogPrototype builder
     */
  ...
  protected StorageCatalogPrototype() { }

  protected StorageCatalogPrototype(Builder builder) {
   ...
   * New builder.
   *
   * @return a StorageCatalogPrototype builder
   */
